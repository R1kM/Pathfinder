...
public class FDIV extends gov.nasa.jpf.jvm.bytecode.FDIV  {
	...
	public Instruction execute (ThreadInfo th) {
	    ...
	    if(sym_v1_ex==null && sym_v2_ex!=null) {
	    	...
	    	NumericCompound<Float> result = new NumericCompound<Float>(sym_v2, NumericOperator.DIV, sym_v1);
		...
		if(condition) { // check div by zero
			...
			if(pc.simplify())  { // satisfiable
				...
				// set the result
				NumericCompound<Float> result = new NumericCompound(sym_v2, NumericOperator.DIV, sym_v1);
