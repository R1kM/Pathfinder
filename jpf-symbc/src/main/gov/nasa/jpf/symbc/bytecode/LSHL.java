  ...
  public Instruction execute (ThreadInfo th) {
	  StackFrame sf = th.getModifiableTopFrame();
	    ...
	    if(sym_v1_ex==null && sym_v2_ex==null)
	    	...
	    	BitvectorExpression<Long> result = BitvectorExpression.create(sym_v2, BitvectorOperator.SHIFTL, new CastExpression<>(sym_v1, BuiltinTypes.SINT64, NumericCastOperation.TO_SINT64));
